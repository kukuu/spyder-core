...
export default function PricingPage() {
  ...
  const premiumBannerAdOptions = [
    { id: "image-6months", duration: "6 months", price: 888, discount: "" },
    { id: "image-12months", duration: "12 months", price: 999, discount: "20% off" }
  ];

  const sideBarPremiumSpotImage = [
    { id: "image-6months", duration: "6 months", price: 180, discount: "" },
    { id: "image-12months", duration: "12 months", price: 288, discount: "20% off" }
  ];

  const sideBarPremiumSpotVideo = [
    { id: "image-6months", duration: "6 months", price: 180, discount: "" },
    { id: "image-12months", duration: "12 months", price: 288, discount: "20% off" }
  ];
  ...
  const calculateTotal = () => {
    ...
    // Combine all image ad options
    const allImageAdOptions = [
      ...premiumBannerAdOptions,
      ...sideBarPremiumSpotImage,
      ...sideBarStandardImage,
      ...adPlacementInContentImage,
      ...productShowCaseImage,
      ...premiumAdPlacementImage
    ];
    
    // Combine all video ad options
    const allVideoAdOptions = [
      ...sideBarPremiumSpotVideo,
      ...sideBarStandardVideo,
      ...adPlacementInContentVideo,
      ...productShowCaseVideo,
      ...premiumAdPlacementVideo,
      ...productBrandStory
    ];
    
    const imageAd = allImageAdOptions.find(opt => opt.duration === selectedImageAd);
    const videoAd = allVideoAdOptions.find(opt => opt.duration === selectedVideoAd);
  ...
  const getSelectedItems = () => {
    ...
    if (selectedImageAd) {
      const option = allImageAdOptions.find(opt => opt.duration === selectedImageAd);
      if (option) {
        items.push({
    ...
    if (selectedVideoAd) {
      const option = allVideoAdOptions.find(opt => opt.duration === selectedVideoAd);
      if (option) {
        items.push({
        ...
        <div className="form-section">
          ...
          <div className="form-group">
              ...
              <div className="options-grid">
                {premiumBannerAdOptions.map((option) => (
                  <div 
          ...
          <div className="form-group">
              ...
              <div className="options-grid">
                {premiumAdPlacementImage.map((option) => (
                  <div 
                    className={`option-card ${selectedImageAd === option.duration ? 'selected' : ''}`}
                    key={option.id}
                    onClick={() => setSelectedImageAd(option.duration)}
            ...
            <div className="form-group">
              ...
              <div className="options-grid">
                {premiumAdPlacementVideo.map((option) => (
                  <div 
                    className={`option-card ${selectedImageAd === option.duration ? 'selected' : ''}`}
                    key={option.id}
                    onClick={() => setSelectedImageAd(option.duration)}
            ...
            <div className="form-group">
              ...
              <div className="options-grid">
                {adPlacementInContentImage.map((option) => (
                  <div 
                    className={`option-card ${selectedImageAd === option.duration ? 'selected' : ''}`}
                    key={option.id}
                    onClick={() => setSelectedImageAd(option.duration)}
            ...
            <div className="form-group">
              ...
              <div className="options-grid">
                {adPlacementInContentVideo.map((option) => (
                  <div 
            ...
            <div className="form-group">
              <h2 className="video-ads"><i className="icon-video"></i> Side Bar Premium Spot Image</h2>
              <p className="section-description">
                Image content in premium placements. Higher engagement
                and conversion rates.
              </p>
              <div className="options-grid">
                {sideBarPremiumSpotImage.map((option) => (
                  <div 
                    className={`option-card ${selectedVideoAd === option.duration ? 'selected' : ''}`}
                    key={option.id}
                    onClick={() => setSelectedVideoAd(option.duration)}
            ...
            <div className="form-group">
              <h2 className="video-ads"><i className="icon-video"></i> Side Bar Premium Spot Video</h2>
              <p className="section-description">
                Video in premium placements. Higher engagement
                and conversion rates.
              </p>
              <div className="options-grid">
                {sideBarPremiumSpotVideo.map((option) => (
                  <div 
                    className={`option-card ${selectedVideoAd === option.duration ? 'selected' : ''}`}
                    key={option.id}
                    onClick={() => setSelectedVideoAd(option.duration)}
            ...
            <div className="form-group">
              <h2 className="video-ads"><i className="icon-video"></i> Side Bar Standard Image</h2>
              <p className="section-description">
                Image content in premium placements. Higher engagement
                and conversion rates.
              </p>
              <div className="options-grid">
                {sideBarStandardImage.map((option) => (
                  <div 
                    className={`option-card ${selectedVideoAd === option.duration ? 'selected' : ''}`}
                    key={option.id}
                    onClick={() => setSelectedVideoAd(option.duration)}
            ...
            <div className="form-group">
              <h2 className="video-ads"><i className="icon-video"></i> Side Bar Standard Video</h2>
              <p className="section-description">
                Video in premium placements. Higher engagement
                and conversion rates.
              </p>
              <div className="options-grid">
                {sideBarStandardVideo.map((option) => (
                  <div 
                    className={`option-card ${selectedVideoAd === option.duration ? 'selected' : ''}`}
                    key={option.id}
                    onClick={() => setSelectedVideoAd(option.duration)}
            ...
            <div className="form-group">
              ...
              <div className="options-grid">
                {productShowCaseImage.map((option) => (
                  <div 
                    className={`option-card ${selectedVideoAd === option.duration ? 'selected' : ''}`}
                    key={option.id}
                    onClick={() => setSelectedVideoAd(option.duration)}
            ...
            <div className="form-group">
              ...
              <div className="options-grid">
                {productShowCaseVideo.map((option) => (
                  <div 
                    className={`option-card ${selectedVideoAd === option.duration ? 'selected' : ''}`}
                    key={option.id}
                    onClick={() => setSelectedVideoAd(option.duration)}
